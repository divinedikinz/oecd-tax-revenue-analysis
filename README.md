...
**Auteure :** Divine Etongo Dikinz Kama · [LinkedIn](https://www.linkedin.com/in/TON-IDENTIFIANT)
**Outils :** Power BI (Power Query, DAX) · sources publiques OCDE / Eurostat / FMI
...
![Composition des recettes fiscales par pays, % du PIB, 2019](figures/01_composition_2019.png)
...
![Évolution de l'impôt sur les sociétés, moyenne OCDE, % du PIB](figures/02_evolution_is.png)
...
![Recettes fiscales et croissance du PIB, 25 pays OCDE, 2014–2024](figures/03_fiscalite_croissance.png)
...
![Corrélation négative fiscalité–croissance](figures/04a_correlation_negative.png)
![Résilience des États-providences au choc COVID 2020](figures/04b_resilience_covid.png)
